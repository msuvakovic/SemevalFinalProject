...
class NeoBERTDetector(nn.Module):
    def __init__(self, manual_feature_dim, num_labels=2):
        ...
        # --- 🛠️ FINAL FIX: Bypass Custom Code by Forcing Standard BERT Architecture 🛠️ ---
        # We load the weights of "chandar-lab/NeoBERT" into the standard BertModel class.
        # This completely avoids all trust_remote_code, xformers, and relative import errors.
        
        try:
            # 1. Load the configuration of the custom model
            config = BertConfig.from_pretrained("chandar-lab/NeoBERT")
